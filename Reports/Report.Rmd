...
![Interactions between Patient Age and Other Categorical Predictors.](./interactions.png){height=30%}
...
7. In the last step, I apply the formula above to all 10 copies of imputed data based on the Rubin combining rules. And the following model summary is obtained:
